  ...
  watch: {
    dataArr(newValue) {
      ...
      this.echartData.list_data.forEach((item, index) => {
        ...
        // console.log(3230000,item["value"])
        // console.log(323000077777,this.echartData.count)


        this.value[index] = ((item["value"] / this.echartData.count) * 100).toFixed(2);
        // console.log(323,this.value[index])
        // console.log(item['name'])
      });
      this.value = this.value.sort();
      // console.log(332312,this.value['length'])
      // console.log(this.value['length'])
      for (let i = 0; i <= this.value["length"]; i++) {
        this.echartData.list_data.forEach((item) => {
          // console.log(item)
          // console.log(this.value)
          if (((item["value"] / this.echartData.count) * 100).toFixed(2) === this.value[i]) {
            this.dataName[i] = item["name"];
          }
        });
      }
      // console.log(3123123,this.value)
      // this.dataName[index] = item["name"];
